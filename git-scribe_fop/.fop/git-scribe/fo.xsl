...
/Users/Ernad Husremovic/.rvm/gems/ruby-1.9.2-p180/gems/git-scribe-0.0.9/docbook-xsl/fo.xsl
...
<!-- hernad utf-8 fontovi -->
<xsl:param name="monospace.font.family" select="'FreeMono'"/>
